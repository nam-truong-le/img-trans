...
describe("find-defect", () => {
    ...
    it("test", async () => {
        ...
        fs.existsSync(path.join(TEMP_DIR, "source", "2017/02/14", "DSC04815.jpg")).should.equal(true);
        fs.existsSync(path.join(TEMP_DIR, "source", "2016/01/03", "DSC02613.ARW")).should.equal(false);
        fs.existsSync(path.join(TEMP_DIR, "source", "2018/01/01", "foo.txt")).should.equal(false);
    ...
    it("don't move", async () => {
        await findDetect.findDefect(path.join(TEMP_DIR, "source"), path.join(TEMP_DIR, "target"), false);

        fs.existsSync(path.join(TEMP_DIR, "source", "2017/02/14", "DSC04815.jpg")).should.equal(true);
        fs.existsSync(path.join(TEMP_DIR, "source", "2016/01/03", "DSC02613.ARW")).should.equal(true);
        fs.existsSync(path.join(TEMP_DIR, "source", "2018/01/01", "foo.txt")).should.equal(true);
